...
const LoadingSpinner = ({ message = "Loading premium market data..." }) => (
  <div className="flex items-center justify-center py-16">
    <div className="relative">
      ...
      <div className="absolute inset-0 w-12 h-12 rounded-full border-4 border-transparent border-r-pink-500 animate-spin animate-spin-reverse animation-delay-150"></div>
    </div>
